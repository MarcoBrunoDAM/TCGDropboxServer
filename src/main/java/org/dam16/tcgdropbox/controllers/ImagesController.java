...
public class ImagesController {
    ...
    public ResponseEntity<String> uploadImageCard(@RequestParam("file")MultipartFile file){
        File tempFile = null;
        String dropboxUrl = "";
        try{
    ...
    public ResponseEntity<String> uploadImageCollection(@RequestParam("file")MultipartFile file){
        File tempFile = null;
        String dropboxUrl = "";
        try{
            String fileName = file.getOriginalFilename();
    ...
    public ResponseEntity<String> uploadImageProduct(@RequestParam("file")MultipartFile file){
        File tempFile = null;
        String dropboxUrl = "";
        try{
            String fileName = file.getOriginalFilename();
